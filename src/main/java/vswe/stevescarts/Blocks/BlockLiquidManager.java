...
public class BlockLiquidManager extends BlockContainerBase
{
    ...
    public void registerBlockIcons(IIconRegister register)
    {
        ...
        this.topIcon = register.registerIcon(var10002.append("stevescarts").append(":").append("liquid_manager").append("_top").toString());
        var10002 = new StringBuilder();
        StevesCarts.instance.getClass();
        this.botIcon = register.registerIcon(var10002.append("stevescarts").append(":").append("liquid_manager").append("_bot").toString());
        var10002 = new StringBuilder();
        StevesCarts.instance.getClass();
        this.redIcon = register.registerIcon(var10002.append("stevescarts").append(":").append("liquid_manager").append("_red").toString());
        var10002 = new StringBuilder();
        StevesCarts.instance.getClass();
        this.blueIcon = register.registerIcon(var10002.append("stevescarts").append(":").append("liquid_manager").append("_blue").toString());
        var10002 = new StringBuilder();
        StevesCarts.instance.getClass();
        this.greenIcon = register.registerIcon(var10002.append("stevescarts").append(":").append("liquid_manager").append("_green").toString());
        var10002 = new StringBuilder();
        StevesCarts.instance.getClass();
        this.yellowIcon = register.registerIcon(var10002.append("stevescarts").append(":").append("liquid_manager").append("_yellow").toString());
    }
