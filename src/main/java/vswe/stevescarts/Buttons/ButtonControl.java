...
{
    public ButtonControl(ModuleComputer module, ButtonBase.LOCATION loc)
    {
        super(module, loc);
    }
    ...
    public boolean isVisible()
    {
        ...
        else if (((ModuleComputer)this.module).getSelectedTasks() != null && ((ModuleComputer)this.module).getSelectedTasks().size() > 0)
        {
            ...
            while (ComputerTask.isControl(task.getType()) && !task.isControlEmpty() && !task.isControlActivator());
