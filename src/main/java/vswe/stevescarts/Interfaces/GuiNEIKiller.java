...
public abstract class GuiNEIKiller extends GuiScreen
{
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        for (int inventoryplayer = 0; inventoryplayer < this.inventorySlots.inventorySlots.size(); ++inventoryplayer)
        {
            Slot itemstack = (Slot)this.inventorySlots.inventorySlots.get(inventoryplayer);
            this.func_146977_a(itemstack);

            if (this.isMouseOverSlot(itemstack, par1, par2) && itemstack.func_111238_b())
            {
                this.theSlot = itemstack;
                GL11.glDisable(GL11.GL_LIGHTING);
                GL11.glDisable(GL11.GL_DEPTH_TEST);
                int itemstack1 = itemstack.xDisplayPosition;
                k1 = itemstack.yDisplayPosition;
                GL11.glColorMask(true, true, true, false);
                this.drawGradientRect(itemstack1, k1, itemstack1 + 16, k1 + 16, -2130706433, -2130706433);
        ...
        if (var16 != null)
        {
            ...
            else if (this.field_147007_t && this.field_147008_s.size() > 1)
            {
                ...
                {
                    j2 = "" + EnumChatFormatting.YELLOW + "0";
                }
            }

            this.drawItemStack(var16, par1 - k - var17, par2 - l - k1, j2);
        }
        ...
        if (this.returningStack != null)
        {
            ...
            int l1 = this.field_147011_y + (int)((float)k1 * var18);
            int i2 = this.field_147010_z + (int)((float)var20 * var18);
        ...
        if (var15.getItemStack() == null && this.theSlot != null && this.theSlot.getHasStack())
        {
            ...
            this.renderToolTip(var19, par1, par2);
        }
