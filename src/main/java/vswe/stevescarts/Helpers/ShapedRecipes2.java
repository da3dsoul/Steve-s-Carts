        ...
        for (int var5 = 0; var5 < 3; ++var5)
        {
            for (int var6 = 0; var6 < 3; ++var6)
            {
                ...
                if (var10 != null || var9 != null)
                {
                    ...
                    if (var9.getItem() instanceof ItemEnchantedBook && var10.getItem() instanceof ItemEnchantedBook && !Items.enchanted_book.func_92110_g(var9).equals(Items.enchanted_book.func_92110_g(var10)))
                    {
                        return false;
                    }
                }
