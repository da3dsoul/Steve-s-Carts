...
public enum ComponentTypes
{
    ...
    DYNAMITE(6, "Dynamite"),
    REMOVED_1(7, (String)null),
    REMOVED_2(8, (String)null),
    ...
    private ComponentTypes(int id, String name)
    {
        this.id = id;
        this.name = name;
    }
    ...
    {
        return StatCollector.translateToLocal(ModItems.component.getUnlocalizedName(this.getItemStack()) + ".name");
    }
}
